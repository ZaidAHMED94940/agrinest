...
const handleFarmerComplaint = async(req,res) => {
    ...
    try {
        ...
        myDoc.text(``) ;
        myDoc.text(``) ;
        myDoc.text(`Dear Sir , I am writing to bring to your attention a pressing issue that concerns the exploitation of local farmers by certain buyers within our community.`) ;
